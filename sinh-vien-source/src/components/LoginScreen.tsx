...
export default function LoginScreen({ onNavigate }: LoginScreenProps) {
  const [username, setUsername] = useState('nguoidung@vnu.edu.vn');
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    onNavigate('ai-retrieval', 'push');
  };

  const handleForgotPassword = (e: React.MouseEvent) => {
    e.preventDefault();
    onNavigate('pass-recovery', 'push');
  };
      ...
      <main className="relative z-10 w-full max-w-[440px] animate-slide-up">
        ...
        <div className="bg-white/95 backdrop-blur-md p-8 rounded-2xl border border-slate-200/80 shadow-xl transition-all duration-300 hover:shadow-2xl">
          <div className="mb-6">
            ...
            <p className="text-xs text-slate-500 font-medium">Vui lòng đăng nhập thông tin cá nhân để truy cập hệ thống.</p>
          </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="nguoidung@vnu.edu.vn"
          ...
          <div className="mt-6 pt-5 border-t border-slate-100 text-center">
            ...
            <button
              onClick={() => onNavigate('ai-retrieval', 'push')}
              type="button"
